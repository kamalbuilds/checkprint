...
loudness. Maya, a post supervisor at an indie distributor, already ran Telestream
Vantage, Venera Pulsar, or Interra Baton. Those tools detect and report. They do not
repair the master and re-measure the repair. Catalog-rank tools (the sibling question
on this track) answer which titles would fail today. Checkprint answers a different
question on one file: did the repair land, and can a stranger reproduce the delta.
