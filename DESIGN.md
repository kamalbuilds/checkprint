...
### Surface & Background
- **Near White** (`#fefefe`): The lightest surface, one step off pure white.
- **Cool Cloud** (`#e9ecf2`): Light section backgrounds with a cool blue-gray tint.
- **Border Dark** (`#27272a`): The single dark-mode border color, low contrast against the surface it bounds.
...
- **Dark Link** (`#0c0c0c`): Darkest link text, close to black.
...
- Border: `1px solid #27272a` (dark mode), low contrast against the surface it bounds
